...
//	private EditText mPasswordView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TelephonyManager tMgr =(TelephonyManager) NewLoginActivity.this.getSystemService(Context.TELEPHONY_SERVICE);
				...
				new View.OnClickListener() {
					...
					public void onClick(View view) {
						if (mWifi.isConnected()) {
							...
							Toast.makeText(NewLoginActivity.this, "Wifi is not Connected! Please Check your WIFI...", Toast.LENGTH_LONG).show();
						}
					}
				});
...
//	    	Intent intent = new Intent(LoginActivity.this, TestActivity.class);
			Intent intent = new Intent(NewLoginActivity.this, TabsFragmentActivity.class);
...
//		    	Intent intent = new Intent(LoginActivity.this, TestActivity.class);
				...
				startActivity(intent);
				Toast.makeText(NewLoginActivity.this, "Login success!!", Toast.LENGTH_SHORT).show();
				finish();
...
//				mPasswordView.requestFocus();
				...
				Toast.makeText(NewLoginActivity.this, "An error occurred during login. Please try again later!!", Toast.LENGTH_LONG).show();
			}
		}
